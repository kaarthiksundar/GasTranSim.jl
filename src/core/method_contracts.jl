const _SUPPORTED_METHODS = (:explicit_staggered_grid, :explicit_staggered_grid_new, :implicit_parabolic, :explicit_hyperbolic, :implicit_hyperbolic, :imex_hyperbolic)
