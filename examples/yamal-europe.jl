...
folder = base_path * "examples/data/yamal-europe/"
...
run_simulator!(ts; sol_snapshot = true, snapshot_period= 50, snapshot_path = output_json, snapshot_filename = "sol-yamal")
