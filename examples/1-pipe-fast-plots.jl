...
ideal =
    lines!(axmain, t, round.(inlet_pressure/1e6; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
...
ideal =
    lines!(axmain, t, round.(outlet_pressure/1e6; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
...
ideal = lines!(axmain, t, round.(inlet_density; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
...
ideal = lines!(axmain, t, round.(outlet_density; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
...
ideal = lines!(axmain, t, round.(inlet_mass_flux; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
...
ideal =
    lines!(axmain, t, round.(outlet_mass_flux; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
...
ideal = lines!(axmain, t, round.(inlet_velocity; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
...
ideal = lines!(axmain, t, round.(outlet_velocity; digits = 2), alpha = 0.7, color = :orange)
cnga = lines!(
    axmain,
    t_cnga,
